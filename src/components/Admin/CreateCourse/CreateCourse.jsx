...
const CreateCourse = () => {
  ...
  const categories = [
    'Full Stack Web Development', 'Artificial Intellegence' , 
    'Data Structure & Algorithms' , 'App Development' , 'Game Development',
    'Data Science' , 'Machine Learning' , 'UI/UX Designer' , 'React Development' , 
    'Ultimate JavaScript' 
  ];
